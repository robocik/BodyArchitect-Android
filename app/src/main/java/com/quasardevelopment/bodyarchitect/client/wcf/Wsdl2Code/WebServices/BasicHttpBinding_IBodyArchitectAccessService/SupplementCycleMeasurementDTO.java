...
public class SupplementCycleMeasurementDTO implements KvmSerializable {
    ...
    public SupplementCycleMeasurementDTO(){}
    
    public SupplementCycleMeasurementDTO(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
