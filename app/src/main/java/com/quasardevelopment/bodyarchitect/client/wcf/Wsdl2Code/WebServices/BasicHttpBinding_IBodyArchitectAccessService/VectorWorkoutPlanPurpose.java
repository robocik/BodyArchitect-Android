...
public class VectorWorkoutPlanPurpose extends Vector<WorkoutPlanPurpose> implements KvmSerializable {
    
    
    public VectorWorkoutPlanPurpose(){}
    
    public VectorWorkoutPlanPurpose(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    //WorkoutPlanPurpose j1= new WorkoutPlanPurpose(j0);
                    //add(j1);
                }
            }
        }
