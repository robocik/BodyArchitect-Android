 ...
 */
public class MarshalWorkoutPlanSearchCriteriaGroup implements Marshal
{
    public Object readInstance(XmlPullParser arg0, String arg1, String arg2,
        ...
        return WS_Enums.WorkoutPlanSearchCriteriaGroup.valueOf(arg0.nextText());
    }

    public void register(SoapSerializationEnvelope arg0) {
        arg0.addMapping("http://tempuri.org/", "WorkoutPlanSearchCriteriaGroup", WS_Enums.WorkoutPlanSearchCriteriaGroup.class,new MarshalWorkoutPlanSearchCriteriaGroup());
    }

    public void writeInstance(XmlSerializer arg0, Object arg1)
            throws IOException {
        arg0.text(((WS_Enums.WorkoutPlanSearchCriteriaGroup)arg1).name());
    }
}