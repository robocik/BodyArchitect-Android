...
public class ScheduleEntryDTO implements KvmSerializable,Serializable {
    ...
    public ScheduleEntryDTO(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("CustomerGroupId"))
        {
            ...
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)){
                SoapPrimitive j =(SoapPrimitive) soapObject.getProperty("CustomerGroupId");
                customerGroupId = j.toString();
            }else if (obj!= null && obj instanceof String){
                customerGroupId = (String) soapObject.getProperty("CustomerGroupId");
            }
        }
