...
public class AppRater {
    ...
    public static void showRateDialog(final Context mContext, final SharedPreferences.Editor editor) {
        ...
        dialog.setTitle(R.string.rate_me_dlg_title);
        ...
        tv.setText(R.string.rate_me_dlg_description);
        tv.setWidth(240);
        tv.setPadding(4, 0, 4, 10);
        ll.addView(tv);

        Button b1 = new Button(mContext);
        b1.setText(R.string.rate_me_dlg_button_rate);
        ...
        b2.setText(R.string.rate_me_dlg_button_remind_later);
        ...
        b3.setText(R.string.rate_me_dlg_button_no_thanks);
