...
public class VectorExerciseType extends Vector<ExerciseType> implements KvmSerializable {
    
    
    public VectorExerciseType(){}
    
    public VectorExerciseType(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    //ExerciseType j1= new ExerciseType(j0);
                    //add(j1);
                }
            }
        }
