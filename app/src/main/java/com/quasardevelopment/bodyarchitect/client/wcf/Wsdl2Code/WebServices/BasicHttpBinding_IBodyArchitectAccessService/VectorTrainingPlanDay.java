...
public class VectorTrainingPlanDay extends Vector<TrainingPlanDay> implements KvmSerializable {
    
    
    public VectorTrainingPlanDay(){}
    
    public VectorTrainingPlanDay(SoapObject soapObject,ReferencesManager referencesTable)     throws ParseException
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    TrainingPlanDay j1= new TrainingPlanDay(j0,referencesTable);
                    add(j1);
                }
            }
        }
