 ...
 */
public class MarshalExerciseType implements Marshal
{
    public Object readInstance(XmlPullParser arg0, String arg1, String arg2,
        ...
        return WS_Enums.ExerciseType.valueOf(arg0.nextText());
    }

    public void register(SoapSerializationEnvelope arg0) {
        arg0.addMapping("http://tempuri.org/", "ExerciseType", WS_Enums.ExerciseType.class,new MarshalExerciseType());
    }

    public void writeInstance(XmlSerializer arg0, Object arg1)
            throws IOException {
        arg0.text(((WS_Enums.ExerciseType)arg1).name());
    }
}
