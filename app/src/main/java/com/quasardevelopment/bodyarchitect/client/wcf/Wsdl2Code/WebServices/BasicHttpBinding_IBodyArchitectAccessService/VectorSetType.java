...
public class VectorSetType extends Vector<com.quasardevelopment.bodyarchitect.client.wcf.Wsdl2Code.WebServices.BasicHttpBinding_IBodyArchitectAccessService.WS_Enums.SetType> implements KvmSerializable {
    
    
    public VectorSetType(){}
    
    public VectorSetType(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
