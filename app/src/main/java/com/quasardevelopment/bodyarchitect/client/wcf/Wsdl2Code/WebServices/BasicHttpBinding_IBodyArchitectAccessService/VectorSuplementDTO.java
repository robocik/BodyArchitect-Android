...
public class VectorSuplementDTO extends Vector<SuplementDTO> implements KvmSerializable {
    
    
    public VectorSuplementDTO(){}
    
    public VectorSuplementDTO(SoapObject soapObject,ReferencesManager referencesTable)    throws ParseException
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    SuplementDTO j1= new SuplementDTO(j0,referencesTable);
                    add(j1);
                }
            }
        }
