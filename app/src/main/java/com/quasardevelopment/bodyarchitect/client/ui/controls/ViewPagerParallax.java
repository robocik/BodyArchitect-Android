...
public class ViewPagerParallax extends ViewPager {
    ...
    public ViewPagerParallax(Context context, AttributeSet attrs) {
        super(context, attrs);
        //setPadding(0, Helper.toDp(150),0,0);
    }
    ...
    private void set_new_background() {
        ...
        try {
            ...
            int bitmap_size = imageHeight * imageWidth * 2 / 1024;
            ...
            if (bitmap_size > freeMemory / 4) {
                //todo:panorama without image is because of this!
        ...
        {
            if (loggable) Log.e(TAG, "Unknown error: " + ex.getMessage());
            background_id = -1;
            return;
        }
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (!insufficientMemory && parallaxEnabled && saved_bitmap!=null) {
            ...
            paint.setAlpha(120);
            canvas.drawBitmap(saved_bitmap, src, dst, paint);
        }
    }
