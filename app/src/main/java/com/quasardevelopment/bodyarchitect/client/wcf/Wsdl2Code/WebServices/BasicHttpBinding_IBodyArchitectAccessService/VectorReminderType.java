...
public class VectorReminderType extends Vector<ReminderType> implements KvmSerializable {
    
    
    public VectorReminderType(){}
    
    public VectorReminderType(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    //ReminderType j1= new ReminderType(j0);
                    //add(j1);
                }
            }
        }
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        info.name = "ReminderType";
        info.type = ReminderType.class;
