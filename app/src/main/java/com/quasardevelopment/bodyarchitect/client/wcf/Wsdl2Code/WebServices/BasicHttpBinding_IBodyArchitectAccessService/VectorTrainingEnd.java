...
public class VectorTrainingEnd extends Vector<TrainingEnd> implements KvmSerializable {
    
    
    public VectorTrainingEnd(){}
    
    public VectorTrainingEnd(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    //TrainingEnd j1= new TrainingEnd(j0);
                    //add(j1);
                }
            }
        }
