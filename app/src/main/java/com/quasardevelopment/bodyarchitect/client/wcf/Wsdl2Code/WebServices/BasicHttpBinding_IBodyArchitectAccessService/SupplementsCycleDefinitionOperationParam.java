...
public class SupplementsCycleDefinitionOperationParam implements KvmSerializable {
    ...
    public SupplementsCycleDefinitionOperationParam(){}
    
    public SupplementsCycleDefinitionOperationParam(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
