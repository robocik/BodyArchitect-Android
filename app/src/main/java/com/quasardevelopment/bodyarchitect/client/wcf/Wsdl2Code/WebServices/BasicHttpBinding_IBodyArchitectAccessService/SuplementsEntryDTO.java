...
public class SuplementsEntryDTO extends EntryObjectDTO implements Serializable {
    
    public VectorSuplementItemDTO items=new VectorSuplementItemDTO();
    
    public SuplementsEntryDTO(){}
    
    public SuplementsEntryDTO(SoapObject soapObject,ReferencesManager referencesTable)     throws Exception
    {
        ...
        if (soapObject.hasProperty("Items"))
        {
            ...
            items = new VectorSuplementItemDTO(j,referencesTable);
        }
    }
    @Override
