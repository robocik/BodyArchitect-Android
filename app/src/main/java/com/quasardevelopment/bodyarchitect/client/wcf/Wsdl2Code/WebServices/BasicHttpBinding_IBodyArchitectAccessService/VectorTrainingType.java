...
public class VectorTrainingType extends Vector<TrainingType> implements KvmSerializable {
    
    
    public VectorTrainingType(){}
    
    public VectorTrainingType(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    //TrainingType j1= new TrainingType(j0);
                    //add(j1);
                }
            }
        }
