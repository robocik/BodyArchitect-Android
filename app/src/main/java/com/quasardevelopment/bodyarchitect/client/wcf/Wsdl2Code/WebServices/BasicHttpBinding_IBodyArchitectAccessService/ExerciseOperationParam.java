...
public class ExerciseOperationParam implements KvmSerializable {
    
    public String exerciseId;
    public FavoriteOperation operation;
    public boolean operationSpecified;
    
    public ExerciseOperationParam(){}
    
    public ExerciseOperationParam(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("Operation"))
        {
            ...
            if (obj!= null && obj.getClass().equals(SoapPrimitive.class)){
                ...
                operation = FavoriteOperation.fromString(j.toString());
            }
        }
