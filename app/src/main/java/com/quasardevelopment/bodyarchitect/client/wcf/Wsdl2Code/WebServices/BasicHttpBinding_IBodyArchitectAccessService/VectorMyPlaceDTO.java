...
public class VectorMyPlaceDTO extends Vector<MyPlaceDTO> implements KvmSerializable {
    
    
    public VectorMyPlaceDTO(){}
    
    public VectorMyPlaceDTO(SoapObject soapObject,ReferencesManager referencesTable)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj!=null && obj.getClass().equals(SoapObject.class)){
                    ...
                    MyPlaceDTO j1= new MyPlaceDTO(j0,referencesTable);
                    add(j1);
                }
            }
        }
    ...
    public void getPropertyInfo(int index, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        info.name = "MyPlaceDTO";
        info.type = MyPlaceDTO.class;
